...
import image from './Images/Ahsan-pic.jpg';
...
const Portfolio = () => {
  ...
  return (
    <div id="#" className="relative flex flex-col items-center justify-center ">
      ...
      <div className="hidden lg:flex flex-col gap-5 rounded-md shadow-lg absolute   m-auto right-10 bg-white dark:bg-slate-900 dark:shadow-slate-800 p-6 h-fit w-1/4  mt-[230px] lg:mt-[550px] mb-6">
